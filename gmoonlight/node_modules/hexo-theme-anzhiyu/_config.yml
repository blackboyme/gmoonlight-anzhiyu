menu:
  ...
  我的:
    音乐馆: /music/?id=8760041674/&server=tencent || anzhiyu-icon-music
...
nav:
  ...
  menu:
    ...
    - title: 推荐
      item:
        - name: 今日毕
          link: https://limengyue.love/todo
...
#   name: link || icon
social:
  Weibo: https://weibo.com/u/3236188135 || anzhiyu-icon-weibo
  BiliBili: https://space.bilibili.com/430685962 || anzhiyu-icon-bilibili

# 作者卡片 状态
author_status:
  enable: true
  # 可以是任何图片，建议放表情包或者emoji图片，效果都很好，[表情包速查](https://emotion.xiaokang.me/)
  statusImg: "https://bu.dusays.com/2021/01/15/dcf30b34409bc.png"
  skills:
    - 🤩 美丽的天使
    - ✨ 善良的菩萨
    - 👧 可爱的女孩
...
# Avatar (头像)
avatar:
  img: https://bu.dusays.com/2021/01/15/dcf30b34409bc.png
  effect: false
...
index_img: "background: url(https://gmoonlight.oss-cn-chengdu.aliyuncs.com/img/202410212304839.JPG) top / cover no-repeat"
...
cover:
  ...
  default_cover:
    - https://gmoonlight.oss-cn-chengdu.aliyuncs.com/img/202410242348886.png
...
reward:
  enable: true
  QR_code:
    - img: /img/wechat_money.jpg
      link:
      text: 微信
    - img: /img/alipay_money.jpg
      link:
      text: 支付宝
...
twikoo:
  envId: https://top.limengyue.love
  region:
  visitor: false
  option:
...
footer:
  ...
  runtime:
    enable: true
    launch_time: 10/20/2024 00:00:00 # 网站上线时间
  ...
  socialBar:
    ...
    left:
      - title: email
        link: mailto:limengyue@qq.com
        icon: anzhiyu-icon-envelope
      - title: 微博
        link: https://weibo.com/u/3236188135
        icon: anzhiyu-icon-weibo
    right:
      - title: Bilibili
        link: https://space.bilibili.com/430685962
...
baidu_analytics: d91e2725992bd4e4278018929420a114

# Google Analytics
# https://analytics.google.com/analytics/web/
google_analytics: G-P3PN70ZWJL
...
runtimeshow:
  enable: true
  publish_date: 10/20/2024 00:00:00
...
home_top:
  ...
  banner:
    tips: 我的一天
    title: 最近去了广西旅游...
    image: https://gmoonlight.oss-cn-chengdu.aliyuncs.com/img/202410212324071.jpg
    link: https://limengyue.love
...
LA:
  enable: true
  ck: 3K61LtrqNtGbNgLO
  LingQueMonitorID: 3K61LtrqNtGbNgLO
...
inject:
  head:
    - <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-9548108880796347" crossorigin="anonymous"></script>
...
album:
  top_background: https://gmoonlight.oss-cn-chengdu.aliyuncs.com/img/202410212304839.JPG
# CDN
