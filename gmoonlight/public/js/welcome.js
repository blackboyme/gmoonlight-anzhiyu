...
$.ajax({
    ...
    data: {
        key: 'DYHBZ-4RP3J-4W2FQ-XIT66-LQ2D7-HWBVR',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(104.0911, 30.4639, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
